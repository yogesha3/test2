...
import com.app.foxhopr.fragments.user.Videos.TrainingVideoFragment;
import com.app.foxhopr.fragments.user.Videos.WebCastFragment;
...
public class VideosFragment extends Fragment implements View.OnClickListener{
    ...
    private void setDefultTab() {
        ...
        textview.setText(getResources().getString(R.string.str_webcast_video));
        WebCastFragment frag = WebCastFragment.newInstance(mLLTopTabs, mLLBottomTabs, mBtnDelete,mBtnReadUnRead, mLLBottomSelectTab, mLLBottomMoreTab, new OnSelectAllTabResponse());
    ...
    public void onClick(View view) {
        if (view == mLlContactsTab && !mStatusSearch) {
            ...
            mLLBottomSelectTab.findViewById(R.id.imgvBottomTabSelect).setAlpha(0.5f);
            TextView textview = (TextView)getActivity().findViewById(R.id.textViewHeaderTitle);
            textview.setText(getResources().getString(R.string.str_training_video));
            setSentTabSelected();
            scrollToCenter(view);

            TrainingVideoFragment frag = TrainingVideoFragment.newInstance(mLLTopTabs, mLLBottomTabs, mBtnDelete,mBtnReadUnRead, mLLBottomSelectTab, mLLBottomMoreTab, new OnSelectAllTabResponse());
            attachedFragement(frag);
