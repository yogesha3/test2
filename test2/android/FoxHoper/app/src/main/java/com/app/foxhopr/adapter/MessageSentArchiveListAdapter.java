 ...
 * Updated by Chobey R. on 18/9/15.
 */
public class MessageSentArchiveListAdapter extends BaseAdapter {
     ...
     * @param context
     */
    public MessageSentArchiveListAdapter(Context context,  ArrayList<InboxListInnerModel> list, MessageListClickCallBack mListClickCallBack) {
        mContext = context;
        mDatalist =list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(mInboxListInnerModel.getRecipient_users() != null && !mInboxListInnerModel.getRecipient_users().equalsIgnoreCase("")){

            toNameStr =mInboxListInnerModel.getRecipient_users();
        ...
        /*if(mInboxListInnerModel.getLname() != null && !mInboxListInnerModel.getLname().equalsIgnoreCase("")){
            toNameStr =  toNameStr+" "+ mInboxListInnerModel.getLname();
        }*/
