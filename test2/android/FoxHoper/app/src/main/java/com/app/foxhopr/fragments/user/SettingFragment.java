...
import com.app.foxhopr.fragments.user.Settings.ChangePasswordFragment;
import com.app.foxhopr.fragments.user.Settings.NotificationsFragment;
...
public class SettingFragment extends Fragment implements View.OnClickListener{
    ...
    private void initView(View view) {
        ...
        mLlContactsTab = (LinearLayout) view.findViewById(R.id.llPasswordTab);
        mLlPartnerTab = (LinearLayout) view.findViewById(R.id.llNotificationTab);

        mTxtvContactTab = (TextView) view.findViewById(R.id.textViewPasswordMessages);
        mTxtvPartnerTab = (TextView) view.findViewById(R.id.textViewNotification);
    ...
    private void setDefultTab() {
        ...
        textview.setText(getResources().getString(R.string.str_change_password));
        ChangePasswordFragment frag = ChangePasswordFragment.newInstance(mLLTopTabs, mLLBottomTabs, mBtnDelete,mBtnReadUnRead, mLLBottomSelectTab, mLLBottomMoreTab, new OnSelectAllTabResponse());
    ...
    public void onClick(View view) {
        if (view == mLlContactsTab && !mStatusSearch) {
            ...
            mLLBottomSelectTab.findViewById(R.id.imgvBottomTabSelect).setAlpha(1f);
            TextView textview = (TextView)getActivity().findViewById(R.id.textViewHeaderTitle);
            textview.setText(getResources().getString(R.string.str_notifications));
            setSentTabSelected();
            scrollToCenter(view);

            NotificationsFragment frag = NotificationsFragment.newInstance(mLLTopTabs, mLLBottomTabs, mBtnDelete,mBtnReadUnRead, mLLBottomSelectTab, mLLBottomMoreTab, new OnSelectAllTabResponse());
            attachedFragement(frag);
