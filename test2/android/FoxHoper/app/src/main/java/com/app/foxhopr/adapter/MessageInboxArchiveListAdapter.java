 ...
 */
public class MessageInboxArchiveListAdapter extends BaseAdapter {
     ...
     * @param context
     */
    public MessageInboxArchiveListAdapter(Context context,  ArrayList<InboxListInnerModel> list, MessageListClickCallBack mListClickCallBack) {
        mContext = context;
        mDatalist =list;
