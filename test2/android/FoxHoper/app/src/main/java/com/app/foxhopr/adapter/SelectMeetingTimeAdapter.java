...
public class SelectMeetingTimeAdapter extends BaseAdapter {
    ...
    public SelectMeetingTimeAdapter(Context context, List<MeetingDayModel> dataArrlist, TextView txtvNoResultFound, ListView mListView, CheckBox mSelectCheckBox, SelectDayClickCallBack mExistContactClickCallBack) {
        mContext = context;
