...
public class MyActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AppUtils.changeStatusBarColor(MyActivity.this);
	...
	private void nitView() {
		...
		leftDrawerList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, int pos, long arg3) {
				...
				// LoginFragement mLoginFragement = new LoginFragement();
				// onFragmentActivated(mLoginFragement);
			}
		});
	...
	public void onFragmentActivated(Fragment mFragement) {
		FragmentManager fragmentManager = getSupportFragmentManager();
		FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
		fragmentTransaction.add(R.id.frame_container, mFragement);
