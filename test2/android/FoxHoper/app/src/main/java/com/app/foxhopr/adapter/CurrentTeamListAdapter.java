 ...
 */
public class CurrentTeamListAdapter extends BaseAdapter {
     ...
     * @param context
     */
    public CurrentTeamListAdapter(Context context, ArrayList<CurrentTeamInnerModel> list, CurrentTeamListClickCallBack mListClickCallBack) {
        mContext = context;
        mDatalist =list;
