...
public class SentArchiveDetailsActivity extends FragmentActivity implements View.OnClickListener {

    private final String TAG="SentArchiveDetails";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sent_archive_referrel_details);
        mRefferalId=getIntent().getStringExtra("referral_id");
        //CommentAlart.stop(SentArchiveDetailsActivity.this);
        //CommentAlart.start(SentArchiveDetailsActivity.this);
        initView();
        initBroadCast();
    ...
    public void initView(){
        ...
        try{
            if (AppUtils.isOnline(SentArchiveDetailsActivity.this)) {
                mProgressHUD = ProgressHUD.show(SentArchiveDetailsActivity.this,"", true,true);
                mProgressHUD.setCancelable(false);
                callWebservice();
            }
            else{
                ErrorMsgDialog.showErrorAlert(SentArchiveDetailsActivity.this, "", getString(R.string.wrng_str_lost_internet_error));
            }
        }catch (Exception ex){
            ex.printStackTrace();
        }
            ...
            public void onClick(View v) {
                try {
                    if(mEditTextMessageComment.getText().toString().length()>0) {
                        ...
                        ErrorMsgDialog.showErrorAlert(SentArchiveDetailsActivity.this, "", getString(R.string.not_comment_blanck));
                    }
                }catch (Exception e){
                    e.printStackTrace();
                }
    ...
    private void callWebservice() throws Exception {
        ...
        RestAdapter restAdapter = new RestAdapter.Builder().setEndpoint(WebServiceConstants.sWEBSERVICE_URL).setRequestInterceptor(WebServiceUtils.getRequestInterceptor(WebServiceConstants.RECEIVED_REFERREL_DETAILSL_ACTION_NAME, WebServiceConstants.REFERRALS_CONTROL_NAME, SentArchiveDetailsActivity.this)).build();
            ...
            public void success(Response responseModel, Response response) {
                ...
                try {
                    if (responseModel != null) {
                        ...
                        ErrorMsgDialog.showErrorAlert(SentArchiveDetailsActivity.this, "", getString(R.string.wrng_str_server_error));
                    }
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
    ...
    private void callCommentWebservice() throws Exception {
        ...
        RestAdapter restAdapter = new RestAdapter.Builder().setEndpoint(WebServiceConstants.sWEBSERVICE_URL).setRequestInterceptor(WebServiceUtils.getRequestInterceptor(WebServiceConstants.RECEIVED_REFERREL_COMMENT_ACTION_NAME, WebServiceConstants.REFERRALS_CONTROL_NAME, SentArchiveDetailsActivity.this)).build();
        RequestApi requestApi = restAdapter.create(RequestApi.class);
    ...
    private void callAddCommentWebservice() throws Exception {
        ...
        RestAdapter restAdapter = new RestAdapter.Builder().setEndpoint(WebServiceConstants.sWEBSERVICE_URL).setRequestInterceptor(WebServiceUtils.getRequestInterceptor(WebServiceConstants.RECEIVED_REFERREL_ADD_COMMENT_ACTION_NAME, WebServiceConstants.REFERRALS_CONTROL_NAME, SentArchiveDetailsActivity.this)).build();
        RequestApi requestApi = restAdapter.create(RequestApi.class);
                    ...
                    if (responseModel != null) {
                        ...
                        if (comment_Response != null) {
                            ...
                            if (comment_Response.getCode().equals(ApplicationConstants.SUCCESS_CODE)) {
                                ErrorMsgDialog.showErrorAlert(SentArchiveDetailsActivity.this, "", comment_Response.getMessage().equals("") ? getString(R.string.wrng_str_no_record) : comment_Response.getMessage(), new OkPressed());
                                mEditTextMessageComment.setText("");
                                //callCommentWebservice();
                            } else {
                                mCommentListView.setVisibility(View.GONE);
                                mNocommentfound.setVisibility(View.VISIBLE);
                                ErrorMsgDialog.showErrorAlert(SentArchiveDetailsActivity.this, "", comment_Response.getMessage().equals("") ? getString(R.string.wrng_str_no_record) : comment_Response.getMessage());
                            }
                        } else {
                            ErrorMsgDialog.showErrorAlert(SentArchiveDetailsActivity.this, "", getString(R.string.wrng_str_server_error));
                        }
        ...
        public void alertAction(boolean select) {
            try {
                if (AppUtils.isOnline(SentArchiveDetailsActivity.this)) {
                    ...
                    intentService = new Intent(SentArchiveDetailsActivity.this, CommentService.class);
    ...
    private void parseReferralsListService(String responseStr) throws Exception {
        ...
        if (get_Response != null) {
            ...
            if (get_Response.getCode().equals(ApplicationConstants.SUCCESS_CODE)) {
                ...
                ErrorMsgDialog.showErrorAlert(SentArchiveDetailsActivity.this, "", get_Response.getMessage().equals("")? getString(R.string.wrng_str_no_record): get_Response.getMessage());
            }
        } else {
            ErrorMsgDialog.showErrorAlert(SentArchiveDetailsActivity.this, "", getString(R.string.wrng_str_server_error));
        }
    ...
    public void setCommentONUI(ReferrelCommentResponseModel comment_Response){
        ...
        if(null!=commentlistAdapter && comment_Response.getResult().size()>commentlistAdapter.getCount()){
            commentlistAdapter=new CommentListAdapter(SentArchiveDetailsActivity.this,comment_Response.getResult(),null);
    ...
    private ReceivedReferralCommentModel getAddCommentRequestModel() throws Exception{
        ...
        mReceivedReferralCommentModel.setDetailPage(WebServiceConstants.SENT_ARCHIVE_LIST_PAGE);
    ...
    private ReferralsDetailsRequestModel getRequestModel() throws Exception{
        ...
        mReferralsDetailsRequestModel.setDetailPage(WebServiceConstants.SENT_ARCHIVE_LIST_PAGE);
