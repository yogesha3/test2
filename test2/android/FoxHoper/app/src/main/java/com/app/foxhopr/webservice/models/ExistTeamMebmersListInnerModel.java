 ...
 */
public class ExistTeamMebmersListInnerModel implements Serializable , Comparable<ExistTeamMebmersListInnerModel>{
    ...
    @Override
    public int compareTo(ExistTeamMebmersListInnerModel another) {
        return this.first_name.toLowerCase().compareTo(another.getFirst_name().toLowerCase());
    }
}
