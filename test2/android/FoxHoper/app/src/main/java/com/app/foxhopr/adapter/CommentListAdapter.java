...
import com.app.foxhopr.webservice.models.CommentModel;
...
public class CommentListAdapter extends BaseAdapter {
	 ...
	 * @param context
	 */
	public CommentListAdapter(Context context, ArrayList<CommentModel>list, ListClickCallBack mListClickCallBack) {
		mContext = context;
		mDatalist =list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.mName.setText(Html.fromHtml(commentText));
