...
import com.app.foxhopr.adapter.PreviousTeamListAdapter;
 ...
 */
public class PreviousTeamFragment extends Fragment implements View.OnClickListener{
    private static String TAG = "PreviousTeamFragment";
    private PreviousTeamListAdapter mPreviousTeamListAdapter;
    ...
    public PreviousTeamFragment() {
        // Required empty public constructor
    }

    public static PreviousTeamFragment newInstance(HorizontalScrollView mLlTopTabs, LinearLayout mLlBottomTabs, Button mBtnDelete,Button mBtnReadUnRead,
                                                  LinearLayout lLBottomSelectTab, LinearLayout lLBottomMoreTab, TabSelectedCallBack mTabSelectedCallBack) {
        PreviousTeamFragment mPreviousTeamFragment = new PreviousTeamFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_previous_team, container, false);
        initView(view);
        return view;
    }
    ...
    AdapterView.OnItemClickListener OnitemClick= new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (AppUtils.isOnline(getActivity())) {
                ...
                detailsReferrels.putExtra("details_page", WebServiceConstants.PREVIOUS_TEAM_LIST_PAGE);
        ...
        if (view == mLLBottomSelectTab) {
            if (isAllSelected) {
                ...
                if (listDataArray != null) {
                    ...
                    mDeletedId.clear();
                    mPreviousTeamListAdapter.notifyDataSetChanged();
                    mBtnDelete.setVisibility(View.GONE);
                    mBtnReadUnRead.setVisibility(View.GONE);
            ...
            public void success(Response responseModel, Response response) {
                ...
                try {
                    if (responseModel != null) {
                        ...
                        mPreviousTeamListAdapter.cleanSelectedArray();
                    } else {
                        ErrorMsgDialog.showErrorAlert(getActivity(), "", getString(R.string.wrng_str_server_error));
                    }
                } catch (Exception ex) {
    ...
    private CurrentTeamRequestModel getSearchRequestModel(String searchText) throws Exception {
        ...
        mCurrentTeamRequestModel.setListPage(WebServiceConstants.PREVIOUS_TEAM_LIST_PAGE);
        ...
        if (get_Response != null) {
            ...
            if (get_Response.getCode().equals(ApplicationConstants.SUCCESS_CODE)) {
                if (get_Response.getListData != null && get_Response.getListData.size() > 0) {
                    ...
                    if (mPreviousTeamListAdapter != null) {
                        mPreviousTeamListAdapter.setData(listDataArray);
                        mPreviousTeamListAdapter.notifyDataSetChanged();
                    } else {
                        setListAdapter();
                    }
    ...
    private void setListAdapter() throws Exception {
        mPreviousTeamListAdapter = new PreviousTeamListAdapter(getActivity(), listDataArray, new OnCheckBoxSeletedResponse());
        // set our adapter and pass our recived list content
        mListViewTeam.setAdapter(mPreviousTeamListAdapter);
