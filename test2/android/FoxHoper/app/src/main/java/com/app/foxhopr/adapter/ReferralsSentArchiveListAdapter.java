...
public class ReferralsSentArchiveListAdapter extends BaseAdapter {
	 ...
	 * @param context
	 */
	public ReferralsSentArchiveListAdapter(Context context, ArrayList<ReferralsListInnerModel> list, ListClickCallBack mListClickCallBack) {
		mContext = context;
		mDatalist =list;
