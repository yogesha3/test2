...
public class SendReferralsNewContactCreationActivity extends FragmentActivity implements View.OnClickListener {
	...
	private void initUi(){
		...
		try{
			if (AppUtils.isOnline(SendReferralsNewContactCreationActivity.this)) {
				mProgressHUD = ProgressHUD.show(SendReferralsNewContactCreationActivity.this,"", true,true);
				mProgressHUD.setCancelable(false);
				callCountryListWebservice();
			}
			else{
				ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_lost_internet_error));
			}
		}catch (Exception ex){
			ex.printStackTrace();
		}
	...
	private void applyValidationFilters() {
		mEdtFirstName.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				Validation.hasInputValid(SendReferralsNewContactCreationActivity.this, mEdtFirstName, mEdtFirstName);
			}
		...
		mEdtLastName.addTextChangedListener(new TextWatcher() {
			@Override
			public void afterTextChanged(Editable s) {
				Validation.hasInputValid(SendReferralsNewContactCreationActivity.this, mEdtLastName, mEdtLastName);
			}
		...
		mEdtOfficePhoneNo.addTextChangedListener(new TextWatcher() {
			@Override
			public void afterTextChanged(Editable s) {
				Validation.hasInputValid(SendReferralsNewContactCreationActivity.this, mEdtOfficePhoneNo, mEdtOfficePhoneNo);
			}
		...
		mEdtEmail.addTextChangedListener(new TextWatcher() {
			@Override
			public void afterTextChanged(Editable s) {
				Validation.hasInputValid(SendReferralsNewContactCreationActivity.this, mEdtEmail, mEdtEmail);
			}
		...
		mEdtEmail.addTextChangedListener(new TextWatcher() {
			...
			@Override
			public void afterTextChanged(Editable s) {
				Validation.isEmailAddressCorrect(SendReferralsNewContactCreationActivity.this, mEdtEmail, mEdtEmail, true);
			}
	...
	private boolean checkValidation() {
		...
		if (strFname.length() == 0 || strLname.length() == 0 || strOfficePhoneNo.length() == 0 || strEmail.length()==0 || strJobTitle.length()==0) {
			...
			if (strJobTitle.trim().length() == 0 ) {
				...
				Validation.hasInputValid(SendReferralsNewContactCreationActivity.this, mEdtJobTitle, mEdtJobTitle);
			}
			...
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_empty_requried_field));
			...
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_fname_max_limit));
		}else if (!Validation.isValidString(strFname)) {
			isAllFieldCorrect = false;
			mEdtFirstName.requestFocus();
			mEdtFirstName.setBackgroundResource(R.drawable.bg_select_team_error);
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_fname_invalid));
		}
		else if (strLname.length() >20 ) {
			isAllFieldCorrect = false;
			mEdtLastName.requestFocus();
			mEdtLastName.setBackgroundResource(R.drawable.bg_select_team_error);
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_lname_max_limit));
		}else if (!Validation.isValidString(strLname)) {
			isAllFieldCorrect = false;
			mEdtLastName.requestFocus();
			mEdtLastName.setBackgroundResource(R.drawable.bg_select_team_error);
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_lname_invalid));
				...
				ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_companyname_max_limit));

		}else if (strCompanyName.length() >0  && !Validation.isValidAddress(strCompanyName))  {
			isAllFieldCorrect = false;
			mEdtCompanyName.requestFocus();
			mEdtCompanyName.setBackgroundResource(R.drawable.bg_select_team_error);
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_companyname_invalid));
		}
			...
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_jobtitle_max_limit));
		}
		/*else if (strJobTitle.length() >0 && !Validation.isValidJobTitle(strJobTitle))  {
			...
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_jobtitle_invalid));
				...
				ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_invalid_email));
			...
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_invalid_url));
				...
				ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_address_max_limit));
		}else if (strAddress.length() >0 && !Validation.isValidAddressFormat(strAddress))  {

			isAllFieldCorrect = false;
			mEdtAddress.requestFocus();
			mEdtAddress.setBackgroundResource(R.drawable.bg_select_team_error);
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_address_invalid));
			...
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_city_max_limit));
		}else if(strCity.length() >0 &&  !Validation.isValidString(strCity)) {
			mEdtAddress.setBackgroundResource(R.drawable.bg_select_team);
			isAllFieldCorrect = false;
			mEdtCity.requestFocus();
			mEdtCity.setBackgroundResource(R.drawable.bg_select_team_error);
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_city_invalid));
		}
			...
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_zipcode_max_limit));
			...
			mEdtZip.requestFocus();
			mEdtZip.setBackgroundResource(R.drawable.bg_select_team_error);
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_zipcode_invalid));
		}else if(strOfficePhoneNo.length() >15){
			mEdtCity.setBackgroundResource(R.drawable.bg_select_team);
			mEdtOfficePhoneNo.requestFocus();
			isAllFieldCorrect = false;
			mEdtOfficePhoneNo.setBackgroundResource(R.drawable.bg_select_team_error);
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_officePhone_max_limit));
			...
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_mobile_phone_max_limit));
		}
	...
	public void onClick(View v) {
		if(v == mlLNext){
			...
			if (checkValidation()) {
				...
				try {
					Intent intObj = new Intent(SendReferralsNewContactCreationActivity.this, SendReferralsNewContactCreationFinalStepActivity.class);
	...
	private void callCountryListWebservice() throws Exception{
		RestAdapter restAdapter = new RestAdapter.Builder().setEndpoint(WebServiceConstants.sWEBSERVICE_URL).setRequestInterceptor(WebServiceUtils.getRequestInterceptor(WebServiceConstants.COUNTRY_ACTION_NAME, WebServiceConstants.COUNTRY_CONTROL_NAME, SendReferralsNewContactCreationActivity.this)).build();
		...
		requestApi.getCountryListRequest(new Callback<Response>() {
			...
			public void failure(RetrofitError error) {
				...
				mProgressHUD.dismiss();
				ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_server_error));
			}
		});
	}
	...
	private void parseCountryService(String responseStr) throws Exception{
		...
		if(get_Response != null){
			if (get_Response.getReponseCode().equals(ApplicationConstants.SUCCESS_CODE)) {
				...
				ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", get_Response.getMessage());
			}
		}else{
			ErrorMsgDialog.showErrorAlert(SendReferralsNewContactCreationActivity.this, "", getString(R.string.wrng_str_server_error));
		}
	...
	private void showCountryList(final ArrayList<CountryListInnerModel> countryListArr) throws Exception {
		if (countryListArr.size() > 0) {
			...
			if(countryList.size() >0){
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(SendReferralsNewContactCreationActivity.this);
				builder.setTitle(SendReferralsNewContactCreationActivity.this.getResources().getString(R.string.str_select_country));
	...
	private void callStateListWebservice() throws Exception{
		RestAdapter restAdapter = new RestAdapter.Builder().setEndpoint(WebServiceConstants.sWEBSERVICE_URL).setRequestInterceptor(WebServiceUtils.getRequestInterceptor(WebServiceConstants.STATE_ACTION_NAME, WebServiceConstants.STATE_CONTROL_NAME, SendReferralsNewContactCreationActivity.this)).build();
		RequestApi requestApi = restAdapter.create(RequestApi.class);
	...
	private void showStateList() throws Exception {
		if (stateListArr != null && stateListArr.size() > 0) {
			...
			if(stateList.size() >0){
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(SendReferralsNewContactCreationActivity.this);
				builder.setTitle(SendReferralsNewContactCreationActivity.this.getResources().getString(R.string.str_select_state));
				builder.setItems(items, new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int item) {
