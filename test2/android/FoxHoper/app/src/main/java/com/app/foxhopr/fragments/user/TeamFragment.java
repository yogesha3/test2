...
import com.app.foxhopr.fragments.user.Team.CurrentTeamFragment;
import com.app.foxhopr.fragments.user.Team.GoalFragment;
import com.app.foxhopr.fragments.user.Team.PreviousTeamFragment;
...
public class TeamFragment extends Fragment implements View.OnClickListener{
    ...
    private void setDefultTab() {
        ...
        textview.setText(getResources().getString(R.string.str_team_member));
        CurrentTeamFragment frag = CurrentTeamFragment.newInstance(mLLTopTabs, mLLBottomTabs, mBtnDelete,mBtnReadUnRead, mLLBottomSelectTab, mLLBottomMoreTab, new OnSelectAllTabResponse());
    ...
    public void onClick(View view) {
        if (view == mLlContactsTab && !mStatusSearch) {
            ...
            PreviousTeamFragment frag = PreviousTeamFragment.newInstance(mLLTopTabs, mLLBottomTabs, mBtnDelete,mBtnReadUnRead, mLLBottomSelectTab, mLLBottomMoreTab, new OnSelectAllTabResponse());
            attachedFragement(frag);

        }else if (view == mLlGoalTab && !mStatusSearch) {
            //mPager.setCurrentItem(1);
            TextView textview = (TextView)getActivity().findViewById(R.id.textViewHeaderTitle);
            textview.setText(getResources().getString(R.string.str_goal));
            setRecivedArchiveTabSelected();
            scrollToCenter(view);

            GoalFragment frag = GoalFragment.newInstance(mLLTopTabs, mLLBottomTabs, mBtnDelete,mBtnReadUnRead, mLLBottomSelectTab, mLLBottomMoreTab, new OnSelectAllTabResponse());
            attachedFragement(frag);
