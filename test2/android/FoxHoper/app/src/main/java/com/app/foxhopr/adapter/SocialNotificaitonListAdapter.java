 ...
 */
public class SocialNotificaitonListAdapter extends BaseAdapter {
     ...
     * @param context
     */
    public SocialNotificaitonListAdapter(Context context, ArrayList<CurrentTeamInnerModel> list, CurrentTeamListClickCallBack mListClickCallBack) {
        mContext = context;
        mDatalist =list;
