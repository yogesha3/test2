...
public class ReferralsRecivedArchiveListAdapter extends BaseAdapter {
	 ...
	 * @param context
	 */
	public ReferralsRecivedArchiveListAdapter(Context context, ArrayList<ReferralsListInnerModel> list, ListClickCallBack mListClickCallBack) {
		mContext = context;
		mDatalist =list;
