...
{
    return [self newActivityViewForView:addToView withLabel:NSLocalizedString(@"", @"Default DSActivtyView label text") width:0];
}
...
- (UIView *)borderView;
{
    if (!_borderView)
    {
        ...
        [_borderView setUserInteractionEnabled:NO];
